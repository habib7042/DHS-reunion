...
const App: React.FC = () => {
  ...
  // Save logo changes
  useEffect(() => {
    localStorage.setItem('dhs_school_logo', schoolLogo);
  }, [schoolLogo]);
    ...
    <div className="min-h-screen flex flex-col font-sans text-slate-800 bg-slate-50">
            ...
            <div className="relative z-10 bg-white shadow-2xl mx-4 md:mx-auto max-w-6xl rounded-2xl -mt-10 p-8 border border-slate-100">
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-slate-100">
                  ...
                  <div className="p-4 group cursor-default">
                     ...
                     <div className="text-4xl font-bold text-slate-800 mb-1 font-serif">96th</div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 mt-auto no-print border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="max-w-md mx-auto text-sm mb-8">Celebrating 96 years of academic excellence and lifelong friendships. Established in 1929.</p>
